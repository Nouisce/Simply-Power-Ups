package net.mcreator.simplypowerups;
...
import net.mcreator.simplypowerups.init.SimplyPowerupsModTabs;
import net.mcreator.simplypowerups.init.SimplyPowerupsModItems;
import net.mcreator.simplypowerups.init.SimplyPowerupsModBlocks;
...
@Mod("simply_powerups")
public class SimplyPowerupsMod {
	public static final Logger LOGGER = LogManager.getLogger(SimplyPowerupsMod.class);
	public static final String MODID = "simply_powerups";

	public SimplyPowerupsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		SimplyPowerupsModBlocks.REGISTRY.register(modEventBus);

		SimplyPowerupsModItems.register(modEventBus);

		SimplyPowerupsModTabs.REGISTRY.register(modEventBus);
